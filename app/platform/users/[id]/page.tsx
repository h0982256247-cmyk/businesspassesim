...
const MEMBER_STATUS: Record<string, { text: string; cls: string }> = {
  PENDING:  { text: '審核中',   cls: 'bg-yellow-50 text-yellow-700' },
  APPROVED: { text: '企業會員', cls: 'bg-green-50 text-green-600' },
  REJECTED: { text: '未通過',   cls: 'bg-red-50 text-red-500' },
}

const TABS = ['基本資料', '訂單紀錄'] as const
