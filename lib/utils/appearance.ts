...
export const APPEARANCE = {
  home: { ratio: 16 / 9, label: '1600 × 900', maxEdge: 1600 }, // 主頁首圖：16:9
  shop: { ratio: 16 / 9, label: '1600 × 900', maxEdge: 1600 }, // 商城頂端圖：16:9（與首圖一致）
  dest: { ratio: 1,      label: '800 × 800',  maxEdge: 1000 }, // 國家卡：1:1 正方形（前台就是接近正方形）
} as const
